...
def main():
    ...
    # 2) page text from the rendered PDF. Blank out the placeholder Table of
    #    Contents page(s): when the PDF is rendered by Word COM (not LibreOffice)
    #    the TOC field is populated, so that page lists EVERY heading — matching a
    #    heading against it would collapse all entries onto the TOC page. Skipping
    #    it makes each heading resolve to its real content page.
